...
class Customer(Base):
    ...
    priority_score = Column(Integer, default=3)  # 1-5 points
...
class Message(Base):
    ...
    retrieved_docs = Column(Text)  # Document snippets retrieved from RAG (JSON format)
